...
This appears to be an AI-assisted QA automation workflow where:

User stories are provided as markdown files
AI agents analyze requirements
Acceptance criteria are extracted
Automated test cases/scripts are eventually generated

The screenshot only shows Step 1 partially; the remaining workflow steps are cut off from the image.
...
Git Repository URL: https://github.com/mindimoses/PlayWrightMCP.git
Prompt:
